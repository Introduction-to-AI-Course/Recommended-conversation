...
def process_session_data(input_filename, output_filename):
    ...
    flag2 = ["问答"]
    #对比处理测试集中的：flag2 = ["问答", "新闻 点播", "音乐 点播"]
    flag3 = ["寒暄"]
    #同上，flag3 = ["问 User 爱好", "天气 信息 推送"]
    # flag4 = ["新闻 推荐"]
    # user_profile key
    p_r_key = ["拒绝"]
...
if __name__ == '__main__':
    add_label('Conversational-Recommendation-BASELINE/conversational_recommendation/goal_planning/origin_data/resource/train.txt', 'Conversational-Recommendation-BASELINE/conversational_recommendation/goal_planning/origin_data/train_add_label.txt')
    add_label('Conversational-Recommendation-BASELINE/conversational_recommendation/goal_planning/origin_data/resource/dev.txt', 'Conversational-Recommendation-BASELINE/conversational_recommendation/goal_planning/origin_data/dev_add_label.txt')
    process_session_data('Conversational-Recommendation-BASELINE/conversational_recommendation/goal_planning/origin_data/train_add_label.txt', 'Conversational-Recommendation-BASELINE/conversational_recommendation/goal_planning/origin_data/train.txt')
    process_session_data('Conversational-Recommendation-BASELINE/conversational_recommendation/goal_planning/origin_data/dev_add_label.txt', 'Conversational-Recommendation-BASELINE/conversational_recommendation/goal_planning/origin_data/dev.txt')
    process_sample_data('Conversational-Recommendation-BASELINE/conversational_recommendation/goal_planning/origin_data/resource/test_1.txt', 'Conversational-Recommendation-BASELINE/conversational_recommendation/goal_planning/origin_data/test.txt')
